  ...
  return (
    <div>
      <footer className="footer footer-center p-10 bg-base-200 text-base font-Poppins-content rounded">
        ...
        <div className="grid grid-flow-col gap-4">
        <img src="https://i.ibb.co/GTYH3pj/sports-academy.png" className="lg:w-28 lg:h-16 h-6 w-10" alt="" />
          <p>Copyright © 2023 - All right reserved by Special Sports Academy</p>
        </div>
      </footer>
    </div>
  );
